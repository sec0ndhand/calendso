...
<p align="center">
  ...
  <h3 align="center">cal.impactsuites.com (formerly Calendso)</h3>

  <p align="center">
    The open-source Calendly alternative.
    <br />
    <a href="https://cal.impactsuites.com"><strong>Learn more »</strong></a>
    <br />
    <br />
    <a href="https://cal.impactsuites.com/slack">Slack</a>
    ·
    <a href="https://cal.impactsuites.com">Website</a>
    ·
...
<p align="center">
   <a href="https://cal.impactsuites.com/slack"><img src="https://img.shields.io/badge/Slack-calendso.slack.com-%234A154B" alt="Join cal.impactsuites.com Slack"></a>
  ...
  <a href="https://cal.impactsuites.com/pricing"><img src="https://img.shields.io/badge/Pricing-%2412%2Fmonth-brightgreen" alt="Pricing"></a>  
...
That's where cal.impactsuites.com comes in. Self-hosted or hosted by us. White-label by design. API-driven and ready to be deployed on your own domain. Full control of your events and data.
...
<a href="https://www.producthunt.com/posts/calendso?utm_source=badge-top-post-badge&utm_medium=badge&utm_souce=badge-calendso" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/top-post-badge.svg?post_id=291910&theme=light&period=monthly" alt="cal.impactsuites.com - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://www.producthunt.com/posts/calendso?utm_source=badge-featured&utm_medium=badge&utm_souce=badge-calendso" target="_blank"><img src="https://api.producthunt.com/widgets/embed-image/v1/featured.svg?post_id=291910&theme=light" alt="cal.impactsuites.com - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a> <a href="https://www.producthunt.com/stories/how-this-open-source-calendly-alternative-rocketed-to-product-of-the-day" target="_blank"><img src="https://cal.impactsuites.com/maker-grant.svg" alt="cal.impactsuites.com - The open source Calendly alternative | Product Hunt" style="width: 250px; height: 54px;" width="250" height="54" /></a>
...
1. Configure environment variables in the .env file. Replace `<user>`, `<pass>`, `<db-host>`, `<db-port>` with their applicable values
   ...
   7. In `Settings`, copy your URI to your cal.impactsuites.com .env file and replace the `postgresql://<user>:<pass>@<db-host>:<db-port>` with it.
...
The Docker configuration for Cal is an effort powered by people within the community. cal.impactsuites.com, Inc. does not provide official support for Docker, but we will accept fixes and documentation. Use at your own risk.
...
9. Under Authorized redirect URI's, select Add URI and then add the URI `<cal.impactsuites.com URL>/api/integrations/googlecalendar/callback` replacing cal.impactsuites.com URL with the URI at which your application runs.
...
4. Set the **Web** redirect URI to `<cal.impactsuites.com URL>/api/integrations/office365calendar/callback` replacing cal.impactsuites.com URL with the URI at which your application runs.
...
9. Set the Redirect URL for OAuth `<cal.impactsuites.com URL>/api/integrations/zoomvideo/callback` replacing cal.impactsuites.com URL with the URI at which your application runs.
...
12. Click "Done".
13. You're good to go. Now you can easily add your Zoom integration in the cal.impactsuites.com settings.
...
Special thanks to these amazing projects which help power cal.impactsuites.com:

[<img src="https://cal.impactsuites.com/powered-by-vercel.svg">](https://vercel.com/?utm_source=calend-so&utm_campaign=oss)
